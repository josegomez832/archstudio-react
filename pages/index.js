...
export default function Home({portfolio}) {
  ...
  return (
    <Container fluid>
        ...
        { /*------------- About -------------*/ }
        <Container className="about-arch section" data-aos="fade-in" data-aos-mirror="true">
          <Row>
            <Col sm={7}>
            ...
            <Col sm={5} className="d-sm-none d-md-block">
              <Image
                  src="/welcome-img.jpg"
                  alt="Welcome to Arch"
                  width={350}
        ...
        { /*------------- Portfolio -------------*/ }
        <Container className='portfolio-section section' data-aos="fade-in" data-aos-mirror="true">
